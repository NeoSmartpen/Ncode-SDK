...
void main()
{
	printf("1) initialize context, handler, pdf document\n\n");
	...
	{
		printf("   3-1(page %d)) load source page and Ncode image\n", i);
		fz_page *page;
		fz_rect rect;
		...
		printf("   3-2(page %d)) combine background image(removed K) and Ncode image\n", i);
		int x, y;
		...
		printf("   3-3(page %d)) insert Ncoded image to destination pdf file\n", i);
		char id[100];
		sprintf(id, "I%d", i);
